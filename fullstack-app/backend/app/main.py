...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        logger.info(
            "Open the app in your browser at http://localhost:8000 or http://127.0.0.1:8000"
        )
        yield
    finally:
...
def frontend_template_exists(template_name: str) -> bool:
    ...
    try:
        return os.path.commonpath([FRONTEND_DIR, template_path]) == FRONTEND_DIR and os.path.isfile(template_path)
    except ValueError:
        return False
